...
public class LongStreamEx extends BaseStreamEx<Long, LongStream, Spliterator.OfLong, LongStreamEx> implements
     ...
     */
    public LongStreamEx removeIf(LongPredicate predicate) {
     ...
     * @since 0.8.7
     */
    public <K, V> EntryStream<K, V> mapToEntry(LongFunction<? extends Map.Entry<K, V>> mapper) {
     ...
     * @since 0.6.1
     */
    public LongStreamEx scan(LongBinaryOperator op) {
     ...
     * @since 0.8.7
     */
    public LongStreamEx scan(long seed, LongBinaryOperator op) {
    ...
    public static LongStreamEx concat(long[] a, long[] b, long[] c) {
        final LongStreamEx s = of(a);

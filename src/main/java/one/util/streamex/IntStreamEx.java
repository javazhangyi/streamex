...
public class IntStreamEx extends BaseStreamEx<Integer, IntStream, Spliterator.OfInt, IntStreamEx> implements IntStream {
     ...
     * @since 0.8.7
     */
    public <K, V> EntryStream<K, V> mapToEntry(IntFunction<? extends Map.Entry<K, V>> mapper) {
     ...
     * @since 0.6.1
     */
    public IntStreamEx scan(IntBinaryOperator op) {
     ...
     * @since 0.8.7
     */
    public IntStreamEx scan(int seed, IntBinaryOperator op) {
